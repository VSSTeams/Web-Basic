  ...
  function initSession() {
    fetch("https://api.chatgpt.com/startSession", {
      ...
      headers: {
        ...
        Authorization:
          "sk-proj-jK0aZ39Uiyv01JYI9PU5T3BlbkFJV7rEm6WAcDxCDKqVCsqS", // Mã API của bạn
      },
    })
  ...
  function sendMessageToAPI(message) {
    fetch("https://api.chatgpt.com/sendMessage", {
      ...
      headers: {
        "Content-Type": "application/json",
        Authorization:
          "sk-proj-jK0aZ39Uiyv01JYI9PU5T3BlbkFJV7rEm6WAcDxCDKqVCsqS", // Thay thế bằng mã API của bạn
      },
      body: JSON.stringify({
        sessionId: sessionId,
        message: message,
